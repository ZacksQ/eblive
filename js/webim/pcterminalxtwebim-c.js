...
var easemob = function () {
    ...
    var appendMsg = function appendMsg(message, type, isappend) {
        ...
        var msgbody = '',
            ...
            headimgwrapper = document.createElement("div"),
            message_type = ext["type"];

        headimgwrapper.appendChild(headimgnode);
        headimgnode.setAttribute("src", ext["headimg"]);
        headimgwrapper.setAttribute("class", "headimg");
        msgnode.appendChild(headimgwrapper);
        var messagediv = document.createElement('div');
        messagediv.setAttribute("class", "message-body");
        ...
        msgp.setAttribute("class", "message-txt");
        switch (message_type) {
            case 1:
